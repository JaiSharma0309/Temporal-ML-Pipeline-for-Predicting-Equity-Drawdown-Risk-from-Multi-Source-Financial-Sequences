...
OUT_DIR    = Path("data/raw/fundamentals")
...
def main():
    ...
    # Strip the .TO suffix back out so symbols match your modeling data
    features_df["symbol"] = features_df["symbol"].str.replace(r"\.TO$", "", regex=True)
